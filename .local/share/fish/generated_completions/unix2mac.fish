...
complete -c unix2mac -o iso --description 'Conversion between \\s-1DOS\\s0 and \\s-1ISO-8859-… [See Man Page]'
...
complete -c unix2mac -s m -l add-bom --description 'Write an \\s-1UTF-8\\s0 Byte Order Mark in the output file.'
complete -c unix2mac -s n -l newfile --description 'New file mode.'
complete -c unix2mac -s o -l oldfile --description 'Old file mode.'
complete -c unix2mac -s q -l quiet --description 'Quiet mode.  Suppress all warnings and messages.'
...
complete -c unix2mac -s R -l replace-symlink --description 'Replace symbolic links with converted files (or… [See Man Page]'
