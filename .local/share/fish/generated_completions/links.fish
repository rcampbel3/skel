...
complete -c links -s g --description 'Run Links2 in graphics mode.'
...
complete -c links -o no-connect --description 'Runs links2 as a separate instance - instead of… [See Man Page]'
...
complete -c links -o user-gamma --description 'Additional gamma.  (default 1).'
